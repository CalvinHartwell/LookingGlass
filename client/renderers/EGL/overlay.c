    ...
    | ImGuiWindowFlags_NoBackground))
  {
    ...
    for (size_t p = 0; p < cvector_size(imgui->primitives); ++p)
    {
      ...
      case 2:
      {
        ...
        ImDrawList_AddRectFilled(dl, p1, p2, boxPtr->innerColor, 0.0f, ImDrawCornerFlags_None);
        ImDrawList_AddRect(dl, p1, p2, boxPtr->outlineColor, 0.0f, ImDrawCornerFlags_None, boxPtr->outlineThickness);
        break;
      }
      case 3:
      {
        LG_Text *textPtr = &imgui->primitives[p];
