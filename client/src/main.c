...
#include "cimgui.h"
#include "../renderers/EGL/imgui_hook/imgui_hook.h"
        ...
        if (header.flags & KVMFR_CURSOR_FLAG_SHAPE &&
            ...
            switch (header.type) {
                case CURSOR_TYPE_COLOR       :
                    cursorType = LG_CURSOR_COLOR;
                    break;
                case CURSOR_TYPE_MONOCHROME  :
                    cursorType = LG_CURSOR_MONOCHROME;
                    break;
                case CURSOR_TYPE_MASKED_COLOR:
                    cursorType = LG_CURSOR_MASKED_COLOR;
                    break;
                default:
...
static LG_ClipboardData spice_type_to_clipboard_type(const SpiceDataType type) {
    switch (type) {
        ...
        case SPICE_DATA_BMP :
            ...
            break;
        case SPICE_DATA_TIFF:
            return LG_CLIPBOARD_DATA_TIFF;
            break;
        case SPICE_DATA_JPEG:
